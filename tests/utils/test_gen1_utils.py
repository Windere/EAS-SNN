...
from yolox.data import GEN1_CLASSES, GEN1Dataset, gen1_collact_func
...
class TestGEN1Utills(unittest.TestCase):
    def setUp(self):
        self.data_dir = '/data2/wzm/dataset/GEN1/raw'
    ...
    #                               )
    #             ax.axes.text(rect.xy[0], rect.xy[1], GEN1_CLASSES[int(cls)],
